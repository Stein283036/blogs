# [String有没有长度限制？](https://hollischuang.github.io/toBeTopJavaer/#/basics/java-basic/length-of-string)
...
## [String的长度限制](https://hollischuang.github.io/toBeTopJavaer/#/basics/java-basic/length-of-string?id=string的长度限制)
...
```markup
public String(byte bytes[], int offset, int length) 复制ErrorOK!
```
...
```markup
String s = "11111...1111";//其中有10万个字符"1"复制ErrorOK!
```
...
## [常量池限制](https://hollischuang.github.io/toBeTopJavaer/#/basics/java-basic/length-of-string?id=常量池限制)
...
## [运行期限制](https://hollischuang.github.io/toBeTopJavaer/#/basics/java-basic/length-of-string?id=运行期限制)
...
4095.9999980926513671875 / 1024 = 3.99999999813735485076904296875 (GB)复制ErrorOK!
```
...
## [总结](https://hollischuang.github.io/toBeTopJavaer/#/basics/java-basic/length-of-string?id=总结)
